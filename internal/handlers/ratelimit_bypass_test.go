...
// Verify that ChangePassword also records re-authentication failure to UserLimiter
// without touching IPLimiter, ensuring IP rotation across password changes trips UserLimiter.
